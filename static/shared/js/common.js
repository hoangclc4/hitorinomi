...
$(document).ready(function() {
	...
	$socialsTwitter += '<div class="social-twitter">';
		$socialsTwitter += '<a href="//twitter.com/share" class="twitter-share-button">Tweet</a>';
		$socialsTwitter += '<script type="text/javascript">!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>';
	$socialsTwitter += '</div>';
	...
	$socialsLine += '<div class="social-line">';
		$socialsLine += '<div class="line-it-button" data-lang="' + __socialsLang + '" data-type="like" data-url="' + locationURL + '" data-share="true" style="display: none;">';
			$socialsLine += '<script src="//d.line-scdn.net/r/web/social-plugin/js/thirdparty/loader.min.js" async="async" defer="defer"></script>';
		$socialsLine += '</div>';
	$socialsLine += '</div>';
...
(function() { // DOM loaded
	...
	if (fbRoot) {
		...
		fbScriptContent += '(function(d, s, id) {';
			...
			fbScriptContent += 'js.src = "//connect.facebook.net/' + fbLanguage + '/sdk.js#xfbml=1&version=v' + fbVersion + '";';
