		...
		$(".fc-form")
			...
			.find(".yubin-bango").each(function() {
				...
				iHTML += '<div class="yubin-postal-code">';
					...
					iHTML += '<div class="yubin-postal-input"><input type="text" name="' + iCode + '" size="8" maxlength="8" id="postal-code" class="p-postal-code w206' + (iRequire ? " require" : "") + '" /><label for="postal-code" class="w164">〒から住所を自動入力</label></div>';
				iHTML += '</div>';
				iHTML += '<div class="yubin-locate">';
					iHTML += '<input type="text" placeholder="○○県○○市○○町1-2-3" name="' + iLocate + '" class="p-region p-locality p-street-address p-extended-address' + (iRequire ? " require" : "") + '" />';
				iHTML += '</div>';
